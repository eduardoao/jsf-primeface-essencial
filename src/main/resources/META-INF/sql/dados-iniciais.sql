...
insert into empresa (id, cnpj, nome_fantasia, razao_social, tipo, data_fundacao, ramo_atividade_id) values (5, '55.134.777/0002-01', 'EAO CORP-TEST', 'EAO EIRELI LTDA', 'EIRELI', '2009-03-02', 1);
insert into empresa (id, cnpj, nome_fantasia, razao_social, tipo, data_fundacao, ramo_atividade_id) values (6, '23.134.888/0002-01', 'EAO20 CORP-TEST', 'EAO20 EIRELI LTDA', 'EIRELI', '2019-04-02', 1);
insert into empresa (id, cnpj, nome_fantasia, razao_social, tipo, data_fundacao, ramo_atividade_id) values (7, '13.134.888/0002-02', 'EAO21 CORP-TEST', 'EAO21 EIRELI LTDA', 'EIRELI', '2022-04-02', 1);